...
def get_vision_model(torch_model):
    ...
    vision_models_dict = {
        ...
        "resnet50_fp16": (models.resnet50(weights="DEFAULT"), default_image_size),
        "resnet101": (models.resnet101(weights="DEFAULT"), default_image_size),
        "squeezenet1_0": (models.squeezenet1_0(weights="DEFAULT"), default_image_size),
        "wide_resnet50_2": (models.wide_resnet50_2(weights="DEFAULT"), default_image_size),
        "mobilenet_v3_small": (models.mobilenet_v3_small(weights="DEFAULT"), default_image_size),
        "mnasnet1_0": (models.mnasnet1_0(weights="DEFAULT"), default_image_size),
        # EfficientNet input image size varies on the size of the model.
        "efficientnet_b0": (models.efficientnet_b0(weights="DEFAULT"), (224, 224)),
        "efficientnet_b7": (models.efficientnet_b7(weights="DEFAULT"), (600, 600)),
    }
